...
export class AppointmentOperationsService {
  ...
  appointmentByDoctorEndPoint:string=this.baseURL+'/appointment/byDoctor';
  appointmentByPatientEndPoint:string=this.baseURL+'/patient/appointment';
  ...
  constructor(private http:HttpClient) { 
    ...
    console.log("Inside Constructor "+this.appointmentByDoctorEndPoint);
  ...
  getAppointmentByDoctor(doctorName:string):Observable<AppointmentDTO[]>{
    console.log("Inside Method 1 "+this.appointmentByDoctorEndPoint);
    this.appointmentByDoctorEndPoint=this.appointmentByDoctorEndPoint+'/'+doctorName;
    console.log("After adding name 2 "+this.appointmentByDoctorEndPoint);

    return this.http.get<AppointmentDTO[]>(`${this.appointmentByDoctorEndPoint}`);
  }
